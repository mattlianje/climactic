...
export interface DT_BaseCombatCharacter {
  // baseclass: DataTable;
  // bcc_localdata: DataTable;
  // bcc_nonlocaldata: DataTable;
  ...
  // m_hMyWearables: DataTable;
}

export interface DT_BaseCombatWeapon {
  // baseclass: DataTable;
  // LocalWeaponData: DataTable;
  // LocalActiveWeaponData: DataTable;
...
export interface DT_BaseGrenade {
  ...
  // DT_AnimTimeMustBeFirst.m_flAnimTime - excluded
...
export interface DT_BasePropDoor {
  // baseclass: DataTable;
  // DT_BaseAnimating.m_flPoseParameter - excluded
  // DT_BaseAnimating.m_flPlaybackRate - excluded
  // DT_BaseAnimating.m_nMuzzleFlashParity - excluded
  // DT_BaseAnimatingOverlay.overlay_vars - excluded
  // DT_BaseFlex.m_flexWeight - excluded
  // DT_BaseFlex.m_blinktoggle - excluded
}
...
export interface DT_CSPlayer {
  ...
  // DT_BaseAnimating.m_flPoseParameter - excluded
  // DT_BaseAnimating.m_flPlaybackRate - excluded
  // DT_BaseAnimating.m_nSequence - excluded
  // DT_BaseAnimating.m_nNewSequenceParity - excluded
  // DT_BaseAnimating.m_nResetEventsParity - excluded
  // DT_BaseAnimating.m_nMuzzleFlashParity - excluded
  // DT_BaseEntity.m_angRotation - excluded
  // DT_BaseEntity.m_vecOrigin - excluded
  // DT_BaseEntity.m_cellbits - excluded
  // DT_BaseEntity.m_cellX - excluded
  // DT_BaseEntity.m_cellY - excluded
  // DT_BaseEntity.m_cellZ - excluded
  // DT_ServerAnimationData.m_flCycle - excluded
  // DT_AnimTimeMustBeFirst.m_flAnimTime - excluded
  // cslocaldata: DataTable;
  // csnonlocaldata: DataTable;
  // csteamdata: DataTable;
  ...
  // m_iMatchStats_Kills: DataTable;
  // m_iMatchStats_Damage: DataTable;
  // m_iMatchStats_EquipmentValue: DataTable;
  // m_iMatchStats_MoneySaved: DataTable;
  // m_iMatchStats_KillReward: DataTable;
  // m_iMatchStats_LiveTime: DataTable;
  // m_iMatchStats_Deaths: DataTable;
  // m_iMatchStats_Assists: DataTable;
  // m_iMatchStats_HeadShotKills: DataTable;
  // m_iMatchStats_Objective: DataTable;
  // m_iMatchStats_CashEarned: DataTable;
  // m_iMatchStats_UtilityDamage: DataTable;
  // m_iMatchStats_EnemiesFlashed: DataTable;
...
export interface DT_CSPlayerResource {
  ...
  m_iPlayerC4: number;
  m_iPlayerVIP: number;
  // m_bHostageAlive: DataTable;
  // m_isHostageFollowingSomeone: DataTable;
  // m_iHostageEntityIDs: DataTable;
  m_bombsiteCenterA: Vector;
  m_bombsiteCenterB: Vector;
  // m_hostageRescueX: DataTable;
  // m_hostageRescueY: DataTable;
  // m_hostageRescueZ: DataTable;
  // m_iMVPs: DataTable;
  // m_iArmor: DataTable;
  // m_bHasDefuser: DataTable;
  // m_bHasHelmet: DataTable;
  // m_iScore: DataTable;
  // m_iCompetitiveRanking: DataTable;
  // m_iCompetitiveWins: DataTable;
  // m_iCompetitiveRankType: DataTable;
  // m_iCompTeammateColor: DataTable;
  // m_bControllingBot: DataTable;
  // m_iControlledPlayer: DataTable;
  // m_iControlledByPlayer: DataTable;
  // m_iBotDifficulty: DataTable;
  // m_szClan: DataTable;
  // m_iTotalCashSpent: DataTable;
  // m_iGunGameLevel: DataTable;
  // m_iCashSpentThisRound: DataTable;
  // m_nEndMatchNextMapVotes: DataTable;
  m_bEndMatchNextMapAllVoted: boolean;
  // m_nActiveCoinRank: DataTable;
  // m_nMusicID: DataTable;
  // m_nPersonaDataPublicLevel: DataTable;
  // m_nPersonaDataPublicCommendsLeader: DataTable;
  // m_nPersonaDataPublicCommendsTeacher: DataTable;
  // m_nPersonaDataPublicCommendsFriendly: DataTable;
}
...
export interface DT_FuncRotating {
  ...
  // DT_BaseEntity.m_angRotation - excluded
  // DT_BaseEntity.m_vecOrigin - excluded
  // DT_BaseEntity.m_flSimulationTime - excluded
  m_vecOrigin: Vector;
...
export interface DT_Inferno {
  // baseclass: DataTable;
  // m_fireXDelta: DataTable;
  // m_fireYDelta: DataTable;
  // m_fireZDelta: DataTable;
  // m_bFireIsBurning: DataTable;
  m_fireCount: number;
}
...
export interface DT_ParticleSystem {
  ...
  // m_iServerControlPointAssignments: DataTable;
...
export interface DT_PlayerResource {
  // m_iPing: DataTable;
  // m_iKills: DataTable;
  // m_iAssists: DataTable;
  // m_iDeaths: DataTable;
  // m_bConnected: DataTable;
  // m_iTeam: DataTable;
  // m_iPendingTeam: DataTable;
  // m_bAlive: DataTable;
  // m_iHealth: DataTable;
  // m_iCoachingTeam: DataTable;
}
...
export interface DT_TeamplayRoundBasedRulesProxy {
  // baseclass: DataTable;
  // teamplayroundbased_gamerules_data: DataTable;
}
...
export interface DT_ScriptCreatedItem {
  ...
  // m_NetworkedDynamicAttributesForDemos: DataTable;
}

export interface DT_AttributeList {
  // m_Attributes: DataTable;
}
...
export interface DT_CSGameRules {
  ...
  // m_iMatchStats_RoundResults: DataTable;
  // m_iMatchStats_PlayersAlive_T: DataTable;
  // m_iMatchStats_PlayersAlive_CT: DataTable;
  // m_GGProgressiveWeaponOrderCT: DataTable;
  // m_GGProgressiveWeaponOrderT: DataTable;
  // m_GGProgressiveWeaponKillUpgradeOrderCT: DataTable;
  // m_GGProgressiveWeaponKillUpgradeOrderT: DataTable;
  ...
  // m_nEndMatchMapGroupVoteTypes: DataTable;
  // m_nEndMatchMapGroupVoteOptions: DataTable;
  ...
  // m_arrFeaturedGiftersAccounts: DataTable;
  // m_arrFeaturedGiftersGifts: DataTable;
  // m_arrProhibitedItemIndices: DataTable;
  m_numBestOfMaps: number;
  // m_arrTournamentActiveCasterAccounts: DataTable;
}
...
export interface DT_CSTeamExclusive {
  // m_iWeaponPurchasesThisMatch: DataTable;
  // m_EquippedLoadoutItemDefIndices: DataTable;
}
