...
export declare interface UserMessages {
  ...
  on(
    ...
    listener: (msg: RequiredNonNullable<ICCSUsrMsg_CloseCaptionDirect>) => void
  ): this;
  on(
    message: "SendAudio",
  ...
  on(
    ...
    listener: (msg: RequiredNonNullable<ICCSUsrMsg_StopSpectatorMode>) => void
  ): this;
  on(
    message: "KillCam",
  ...
  on(
    ...
    listener: (msg: RequiredNonNullable<ICCSUsrMsg_DesiredTimescale>) => void
  ): this;
  on(
    message: "CurrentTimescale",
    listener: (msg: RequiredNonNullable<ICCSUsrMsg_CurrentTimescale>) => void
  ): this;
  on(
    message: "AchievementEvent",
    listener: (msg: RequiredNonNullable<ICCSUsrMsg_AchievementEvent>) => void
  ): this;
  on(
    message: "MatchEndConditions",
    listener: (msg: RequiredNonNullable<ICCSUsrMsg_MatchEndConditions>) => void
  ): this;
  on(
    message: "DisconnectToLobby",
    listener: (msg: RequiredNonNullable<ICCSUsrMsg_DisconnectToLobby>) => void
  ): this;
  on(
    message: "PlayerStatsUpdate",
    listener: (msg: RequiredNonNullable<ICCSUsrMsg_PlayerStatsUpdate>) => void
  ): this;
  on(
    message: "DisplayInventory",
    listener: (msg: RequiredNonNullable<ICCSUsrMsg_DisplayInventory>) => void
  ): this;
  on(
  ...
  on(
    ...
    listener: (msg: RequiredNonNullable<ICCSUsrMsg_ServerRankRevealAll>) => void
  ): this;
  on(
  ...
  on(
    ...
    listener: (msg: RequiredNonNullable<ICCSUsrMsg_ServerRankUpdate>) => void
  ): this;
  on(
    message: "ItemPickup",
  ...
  on(
    ...
    listener: (msg: RequiredNonNullable<ICCSUsrMsg_MarkAchievement>) => void
  ): this;
  on(
    message: "MatchStatsUpdate",
    listener: (msg: RequiredNonNullable<ICCSUsrMsg_MatchStatsUpdate>) => void
  ): this;
  on(
    message: "ItemDrop",
  ...
  on(
    ...
    listener: (msg: RequiredNonNullable<ICCSUsrMsg_GlowPropTurnOff>) => void
  ): this;
  on(
    message: "SendPlayerItemDrops",
    listener: (msg: RequiredNonNullable<ICCSUsrMsg_SendPlayerItemDrops>) => void
  ): this;
  on(
  ...
  on(
    ...
    listener: (msg: RequiredNonNullable<ICCSUsrMsg_SendPlayerItemFound>) => void
  ): this;
  on(
    message: "ReportHit",
